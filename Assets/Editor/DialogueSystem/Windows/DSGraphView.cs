...
namespace DS.Windows
{
    ...
    public class DSGraphView : GraphView
    {
        ...
        private void AddManipulators()
        {
            ...
            this.AddManipulator(CreateNodeContextualMenu("Add Node (Single Dialog)", DSDialogueType.SingleChoice));
            this.AddManipulator(CreateNodeContextualMenu("Add Node (Multi Dialog)", DSDialogueType.MultipleChoice));
            this.AddManipulator(CreateNodeContextualMenu("Add Node (Action)", DSDialogueType.Action));
